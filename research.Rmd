...
This page lists some of my academic research interests, working papers, and past publications. You can also view PDFs of my [full academic CV](Hauer_CV.pdf).

### Working Papers

**Hauer, M.** & Santos, A. *Climate change could reduce European life expectancy.*  [[PDF]](https://osf.io/preprints/socarxiv/ngtxr)

**Hauer, M.**, Saunders, RK, & Shtob, D. *The Path of Least Resistance: Projections of Social Inequalities as a Result of Climate Change in the United States.* [[PDF]](https://osf.io/preprints/socarxiv/7jtrn/)

Keenan, J. M., & **Hauer, M.** *Resilience for Whom? Demographic Change and the Redevelopment of the Built Environment in Puerto Rico.*

Landon, C., Lyles, R., Scovronick, N., Abadi, A., Bilotta, R., **Hauer, M.**, Bell, J., & Gribble, M. *Mixed-effects negative binomial regression with interval censoring: a simulation study  and application to aridity and all-cause mortality among black South Africans over 1997-2013.* 
...
<table class="padded-table">
 ...
 <tr><td>[17.]  **Hauer, M.**, Holloway S., & Oda, T. (2020)  "Evacuees and Migrants Exhibit Different Migration Systems after the Great East Japan Earthquake and Tsunami." Forthcoming in *Demography*. </td><td>[WEB](https://osf.io/preprints/socarxiv/76y5z/) / [PDF]()</td><td></td></tr>

 <tr><td>[16.]  **Hauer, M.** & Schmertmann, C. (2020)  "Population pyramids yield accurate estimates of total fertility rates." Forthcoming in *Demography*. </td><td>[WEB](https://osf.io/preprints/socarxiv/2f3v6/) / [PDF]()</td><td></td></tr>
