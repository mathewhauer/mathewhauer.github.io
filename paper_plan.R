...
papers <- tribble(
  ...
  10, 2019, "CC Life expectancy", "Hauer, Santos", 1, 0,1, 1, 1, 1, 0, 0, "Demography", "CC mortality",
  11, 2019, "Louisiana SLR", "Hauer, Hardy, Mishra, Pippin", 1, 1,1, 1, 1, 1, 0, 0, "Pop & Env", "dissertation",
  12, 2019, "iTFR2", "Hauer, Schmertmann", 1,0,1,1,1,0,0,0,"Proceedings of the National Acadmies of Sciences", "iTFR",
